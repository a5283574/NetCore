  ...
  <div>
    <div class="container" :style='{"minHeight":"100vh","alignItems":"center","background":"url(http://codegen.caihongy.cn/20230801/5db22557138c43aa955609b9d805a0a9.jpg)","display":"flex","width":"100%","backgroundSize":"cover","backgroundPosition":"center top","backgroundRepeat":"no-repeat","justifyContent":"center"}'>
      <el-form :style='{"border":"0px solid #eee","padding":"150px 60px 20px 600px","boxShadow":"0 0px 0px rgba(64, 158, 255, .6)","margin":"0","borderRadius":"10px","background":"url(http://codegen.caihongy.cn/20230801/017937c712194d5e8a38f9bca47c4a73.png) no-repeat center top / cover","width":"1200px","fontSize":"16px","height":"690px"}'>
        <div v-if="true" :style='{"padding":"10px","margin":"0 auto 30px","color":"#56b2c6","textAlign":"center","background":"none","width":"96%","lineHeight":"40px","fontSize":"24px","textShadow":"4px 4px 2px rgba(64, 158, 255, .1)"}' class="title-container">网络安全等级测评项目管理系统登录</div>
        ...
        <div :style='{"margin":"90px auto 0","alignItems":"center","flexWrap":"wrap","display":"flex","width":"80%","position":"relative","justifyContent":"center"}'>
          ...
          <el-button :style='{"border":"0px solid rgba(64, 158, 255, 1)","cursor":"pointer","padding":"0 12px","margin":"0 5px","outline":"none","color":"#666","borderRadius":"0px","background":"rgba(64, 158, 255, .0)","width":"auto","fontSize":"inherit","height":"44px"}' type="primary" @click="register('yonghu')" class="register">注册用户</el-button>
          <el-button :style='{"border":"0px solid rgba(64, 158, 255, 1)","cursor":"pointer","padding":"0 12px","margin":"0 5px","outline":"none","color":"#666","borderRadius":"0px","background":"rgba(64, 158, 255, .0)","width":"auto","fontSize":"inherit","height":"44px"}' type="primary" @click="register('cepingshi')" class="register">注册测评师</el-button>
        </div>
      </el-form>
