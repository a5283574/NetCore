  ...
  <div :style='{"color":"#666","padding":"20px 30px 30px","fontSize":"14px"}'>
    ...
    >  
     <el-row>
        ...
        <el-form-item :style='{"color":"inherit","margin":"0 0 20px 0","fontSize":"inherit"}'   v-if="flag=='cepingshi'"  label="测评账号" prop="cepingzhanghao">
          <el-input v-model="ruleForm.cepingzhanghao" readonly              placeholder="测评账号" clearable></el-input>
        </el-form-item>
        <el-form-item :style='{"color":"inherit","margin":"0 0 20px 0","fontSize":"inherit"}'   v-if="flag=='cepingshi'"  label="测评姓名" prop="cepingxingming">
          <el-input v-model="ruleForm.cepingxingming"               placeholder="测评姓名" clearable></el-input>
        </el-form-item>
        <el-form-item :style='{"color":"inherit","margin":"0 0 20px 0","fontSize":"inherit"}' v-if="flag=='cepingshi'"  label="性别" prop="xingbie">
          <el-select v-model="ruleForm.xingbie"  placeholder="请选择性别">
            <el-option
        ...
        <el-form-item :style='{"color":"inherit","margin":"0 0 20px 0","fontSize":"inherit"}'   v-if="flag=='cepingshi'"  label="年龄" prop="nianling">
          <el-input v-model="ruleForm.nianling"               placeholder="年龄" clearable></el-input>
        </el-form-item>
        <el-form-item :style='{"color":"inherit","margin":"0 0 20px 0","fontSize":"inherit"}' v-if="flag=='cepingshi'" label="头像" prop="touxiang">
          <file-upload
          tip="点击上传头像"
          action="file/upload"
          :limit="3"
        ...
        <el-form-item :style='{"color":"inherit","margin":"0 0 20px 0","fontSize":"inherit"}'   v-if="flag=='cepingshi'"  label="联系方式" prop="lianxifangshi">
...
export default {
  ...
  methods: {
    ...
    onUpdateHandler() {
      ...
      if((!this.ruleForm.cepingzhanghao)&& 'cepingshi'==this.flag){
        this.$message.error('测评账号不能为空');
        return
      }


      if((!this.ruleForm.mima)&& 'cepingshi'==this.flag){
        this.$message.error('密码不能为空');
        return
      }
      ...
      if( 'cepingshi' ==this.flag && this.ruleForm.lianxifangshi&&(!isMobile(this.ruleForm.lianxifangshi))){
